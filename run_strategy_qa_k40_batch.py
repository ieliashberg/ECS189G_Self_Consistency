#!/usr/bin/env python
"""
Run GPT-3.5-Turbo on StrategyQA with self-consistency (k=40) via OpenAI Batch API.

Usage:
    python run_strategy_qa_k40_batch.py                  # submit + wait + evaluate
    python run_strategy_qa_k40_batch.py --submit-only     # submit and print batch ID
    python run_strategy_qa_k40_batch.py --resume BATCH_ID  # resume a previously submitted batch
"""
...
MODEL = "gpt-3.5-turbo"
BENCHMARK = BenchmarkType.STRATEGY_QA
K = 40
TEMPERATURE = 0.7
OUTPUT_CSV = Path("results/strategy_qa_k40_gpt35_batch.csv")
